...
mkHomePage _uid _isRegistered =
  pageLayout "melosz" $ do
    H.div H.! A.class_ "grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16" $ do
      H.div H.! A.class_ "ds-skeleton h-96 justify-self-stretch" $ "a/b"
      H.div H.! A.class_ "ds-skeleton h-96 justify-self-stretch" $ "democracy"
      H.div H.! A.class_ "ds-skeleton h-96 justify-self-stretch" $ "singles"
      H.div H.! A.class_ "ds-skeleton h-96 justify-self-stretch" $ "doubles"
