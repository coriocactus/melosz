...
mkHomePage _uid isRegistered =
  pageLayout (if isRegistered then User else Guest) "melosz" $ do
    H.div H.! A.class_ "grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-8" $ do
      ...
      H.a H.! A.href "#" H.! A.class_ "ds-skeleton h-[40dvh] justify-self-stretch transition-transform hover:scale-101 duration-300" $ "confidant"
      H.a H.! A.href "#" H.! A.class_ "ds-skeleton h-[40dvh] justify-self-stretch transition-transform hover:scale-101 duration-300" $ "conclave"
